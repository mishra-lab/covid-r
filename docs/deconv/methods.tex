...
% JK: I think good to acknowledge here (and not overstate our contributions)  SM: i like the revisions
...
is the convolution of their respective distributions~\cite{Hogg2005},  %SM: good citation and explanation
...
% JK: not sure if this ^ belongs here... SM: agree, move to Discussion but state like that/as worded
% ==============================================================================
...
to reflect uncertainty in reporting delay.  %SM: nice i like this. 
