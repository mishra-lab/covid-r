...
%     the same parametric definition of S(t) from Du2020, in eq (4).
...
%     but let me know if you think it should also appear in the main text.
...
%     just don't want to overwhelm the big-picture trend with numbers...
%     Similarly, I originally had the 95% CI but it felt cluttered...
...
%     and Britton et al really do examine exactly this.
